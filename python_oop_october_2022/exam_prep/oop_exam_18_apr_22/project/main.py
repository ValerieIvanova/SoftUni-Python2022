from exam_prep.oop_exam_18_apr_22.project.movie_app import MovieApp
from exam_prep.oop_exam_18_apr_22.project.movie_specification.fantasy import Fantasy
from exam_prep.oop_exam_18_apr_22.project.movie_specification.action import Action
